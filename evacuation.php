        ...
        <div class="flex flex-col gap-4">
            ...
            <nav class="flex flex-col gap-2">
                <a class="flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-white/10" href="dashboard.php">
                    <span class="material-symbols-outlined text-white">dashboard</span><p class="text-white text-sm font-medium">Dashboard</p>
                </a>
                ...
                <a class="flex items-center gap-3 rounded-lg bg-primary/20 px-3 py-2" href="evacuation.php">
                    <span class="material-symbols-outlined text-primary">warehouse</span><p class="text-primary text-sm font-medium">Evacuation</p>
                </a>
        ...
        <div class="flex-1 overflow-y-auto p-6 lg:p-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-[#1c2127] p-6 rounded-xl border border-[#283039] sticky top-0 shadow-lg">
                        ...
                        <form id="add-center-form" class="flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div id="center-map" class="border border-[#3b4754] bg-[#111418]"></div>
